...
- On desktop widths, sidebar navigation links are always visible; on mobile widths (around `900px` and below), sidebar navigation collapses to a hamburger button and the menu links expand horizontally with wrapping when opened.
